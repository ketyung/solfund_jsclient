...
export const FundPoolCardView2 : React.FC <FundPoolCardView2Props> = ({address, 
    ...
    return <div className={className}>
        ...
        <Tooltip placement="bottom" overlayStyle={{maxWidth: '500px'}} title={fundPool?.manager.toBase58()} arrowPointAtCenter>
        <div className="item">Manager : { className === "fundPool" ? fundPool?.manager.toBase58() : 
