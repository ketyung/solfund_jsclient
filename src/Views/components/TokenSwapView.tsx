...
import { Form, Input, Image, Dropdown } from 'antd';
...
export const TokenSwapView : React.FC = () => {
    ...
    return <div>
        ...
        required tooltip="From Token">
            ...
            <span style={{color:"white",marginLeft:"10px"}}>{tokenA?.symbol ? tokenA.symbol : "SOL"}</span>
            </div>
            </Dropdown>
        </Form.Item>
        ...
        required tooltip="To Token">
            ...
            fallback="data:image/png;base64,"/>
             <span style={{color:"white",marginLeft:"10px"}}>{tokenB?.symbol ? tokenB.symbol : "SOL"}</span>
            </div>
            </Dropdown>
