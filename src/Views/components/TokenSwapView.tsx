...
export const TokenSwapView : React.FC = () => {
    ...
    return <div>
        ...
        <Form.Item label={<label style={{ color: "white", fontSize:"10pt" }}>From</label>} 
        required tooltip="From Token">
            <div style={{minWidth: "40%", display:"inline-block"}}>
            <Input placeholder="0.00" style={{maxWidth:"200px",height:"40px",backgroundColor:"#334", color:"white"}} />
            </div>

            <div style={{minWidth: "5%" ,display:"inline-block", textAlign:"left"}}>
            <Button style={{backgroundColor:"transparent",border:"0px"}}>
                <Image width={40} height={40}  title="Icon" alt="Icon" 
                style={{ verticalAlign: 'middle', marginTop:"5px", marginRight:"20px"}} preview={false}
                src={tokenA?.logoURI ? tokenA.logoURI : defaultImage}
